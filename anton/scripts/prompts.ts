...
const keywordLimit = numericFlag(args, '--keyword-limit') ?? 100;
const topKeywords = numericFlag(args, '--top-keywords') ?? 10;
const promptsPerKeyword = numericFlag(args, '--prompts-per-keyword') ?? 3;
...
const candidatePool = numericFlag(args, '--candidate-pool') ?? 50;
